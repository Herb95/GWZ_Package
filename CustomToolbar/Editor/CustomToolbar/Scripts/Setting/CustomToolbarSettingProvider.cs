...
using Custom_Toolbar.ToolbarElements;

namespace Custom_Toolbar.Setting
{
    internal class CustomToolbarSettingProvider : SettingsProvider
    {
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            elementsList = elementsList ?? CustomToolbarReorderableList.Create(setting.elements, OnMenuItemAdd);
