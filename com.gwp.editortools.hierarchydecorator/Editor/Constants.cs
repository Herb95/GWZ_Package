...
namespace Gwp.EditorTools.HierarchyDecorator
{
    ...
    {
        internal readonly static Texture2D CheckboxEmpty = EditorResources.Load<Texture2D> ("Icons/checkbox_filled");
        internal readonly static Texture2D CheckboxFilled = EditorResources.Load<Texture2D> ("Icons/checkbox_empty");

        internal readonly static Texture2D Checked = EditorResources.Load<Texture2D> ("Icons/checked");
        internal readonly static Texture2D Checkbox = EditorResources.Load<Texture2D> ("Icons/checkBox");

        internal readonly static Texture2D Checkmark = EditorResources.Load<Texture2D> ("Icons/checkmark");

        internal readonly static Texture2D Banner = EditorResources.Load<Texture2D> ("HierarchyDecoratorLogo");
    }
